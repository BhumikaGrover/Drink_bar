  ...
  var app = {
    ...
    receivedEvent: function(id) {
      ...
      var clientIDs = {
        ...
        "PayPalEnvironmentSandbox": "ASUcMLBF2-CbGzsrE0mjyaI-NpdOtmzaZ4hGx7NodaUkDLO10xnwt2Z_ZyinpZBURl7pHzIedESyp9mc"
      };
...
//               console.log($rootScope.cate_monthly,$rootScope.cate_yearly);
    ...
    $scope.planbuy=function(plan_id,price,image,dis,name,discount){
          ...
          console.log($rootScope.plan_dis);
                    ...
                    if(response.status == 1){
                       ...
                       if($rootScope.currentLanguage=="English") {
                        ...
                        var myPopup = $ionicPopup.show({
                            ...
                            title: 'You are already registered with',
...
//                    }
                    if(response.status == 0){
                        ...
                        var myPopup = $ionicPopup.show({
                            ...
                            title: 'The email ' + $scope.data.formdata.email + ' is already registered with another device',
                           // template: "You must be 18 or older to use Boozie.",
                            cssClass: 'value_sec',
                            scope: $scope,
                            buttons: [
                            ...
                            title: 'Die Email ' + $scope.data.formdata.email + 'Ist bereits bei einem anderen Gerät registriert',
                           // template: "You must be 18 or older to use Boozie.",
                            cssClass: 'value_sec',
                            scope: $scope,
                            buttons: [
...
//                    }
       ...
       var deviceInformation = ionic.Platform.device();
        $rootScope.deviceid = deviceInformation.uuid;
       // alert($rootScope.deviceid);
   facebookConnectPlugin.login(["email","public_profile","user_birthday","user_location"], fbLoginSuccess,
...
if(dataresponse.data.status  == 0){
                    ...
                    if(dataresponse.data.status  == 1){
                        ...
                        var myPopup = $ionicPopup.show({
                            ...
                            title: 'You are already registered with ',
                            template: dataresponse.data.email,
                            cssClass: 'value_sec',
                            scope: $scope,
                            buttons: [
                            { text: '<span class="oky">Okay</span>',
...
.controller('sliderCtrl', function ($scope, $stateParams, $state, $translate,$ionicSlideBoxDelegate,$ionicSideMenuDelegate,$rootScope,$window,$http,$ionicHistory,Base_URL,$httpParamSerializer,$ionicLoading,$ionicPopup) {
...
//    var demo_link_new = "http://rajdeep.crystalbiltech.com/thoag/signin"
   var test_link = "https://itunes.apple.com/us/app/apple-store/id375380948";
...
//    var message = "Hi, Check "+restaurant_name+" at the following link  "+test;
    var message = "Install and get Free Drinks " +test_link+  " Use a Referral code: " +coupon ;
   // console.log(message)
...
//    //var message = "Hi, Check "+restaurant_name+" at the following link  "+test+" Check demo link here "+demo_link_new+" "+test_link;
//    var message = "Hi, Check "+restaurant_name+" at the following link  "+test;
    var message = "Installieren und Kostenlose Getränke bekommen " +test_link+  " Verwenden Sie einen Empfehlungscode: " +coupon ;
   // console.log(message)
     $cordovaSocialSharing
    .share(message) // Share via native share sheet
    .then(function(result) {
...
function ($scope, $stateParams,$window,$state,$ionicHistory,$rootScope,$ionicLoading,Base_URL,$http,$httpParamSerializer) {
 $rootScope.Userid = $window.localStorage.getItem("user_id");
            ...
            if(response.error == 0){
                ...
                $scope.$broadcast('timer-stop');
                 ...
                 var myPopup = $ionicPopup.show({
                            ...
                            title:" Glückwünsche!",
                            template: "Genießen Sie Ihr freies Getränk u. Spitze Ihr Barmixer. Wir sehen uns morgen für ein weiteres freies Getränk!",
                            cssClass: 'value_sec',
                            scope: $scope,
                            buttons: [
                            { text: '<span class="oky">Okay</span>',
